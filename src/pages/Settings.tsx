      ...
      <div className="max-w-md mx-auto px-4 py-6 space-y-6">
        ...
        <div className="glass-card p-4">
          ...
          <div className="space-y-3">
            <Label htmlFor="calorieGoal" className="text-foreground text-sm">
            ...
            <Input
              ...
              onChange={(e) =>
                setSettings({ ...settings, dailyCalorieGoal: e.target.value })
              }
              placeholder="2200"
            ...
            />
            <p className="text-xs text-muted-foreground">
              This goal will be used to track your daily progress. You can also
              set this automatically in your Profile.
            </p>
          </div>
        </div>
        ...
        <div className="glass-card p-4">
          ...
          <div className="space-y-3">
            <Label htmlFor="mealTags" className="text-foreground text-sm">
            ...
            <Input
              ...
              onChange={(e) =>
                setSettings({ ...settings, defaultMealTags: e.target.value })
              }
        ...
        <div className="glass-card p-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="reminders" className="text-foreground text-sm">
